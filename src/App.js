...
//           <img src={state === 'dark' ? HamburgerIcon : HamburgerDark} alt="" className="HamburgerLight" />
...
//           <img src={state === 'dark' ? UserIconLight : UserIconDark} alt="User Icon" className="icon" />
//           <img src={state === 'dark' ? ShoppingCart : ShoppingCartDark} alt="User Icon" className="icon" />
//         </div>
//       </div>
//     </div>
//   );
    ...
    <div className="App">
      <div className="NavBarRectangle-17">
        ...
        <div className="NavBarRectangle-15">
          ...
          <div className="HamburgerLight">
            <img src={state === 'light' ? HamburgerIcon : HamburgerDark} alt="" className="HamburgerLight" />
            {/* <img src={HamburgerIcon} alt="Hamburger Icon" width="30" height="22" /> */}
          ...
          <div className="icon-container">
            ...
            <img src={state === 'light' ? ShoppingCart : ShoppingCartDark} alt="User Icon" className="icon" />
          </div>
        </div>
      </div>
